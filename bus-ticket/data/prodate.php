...
else if(($_SESSION['log_user']!="hari_nara")||($_SESSION['pass']!="827ccb0eea8a706c4c34a16891f84e7b"))
	{echo "<br><a href='http://localhost/bus-ticket/data/log.php'>LOGIN</a><br>";die("Please login as admin to continue");
	}
else 
{
